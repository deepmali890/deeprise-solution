...
// import { toast } from 'your-toast-library'; // <-- Add your toast library import here
...
const ContactForm = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "ef7741e0-8b26-4ccc-8b98-749280618d62");
        ...
        <section className="bg-black">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    ...
                    <h1 className="mt-2 text-2xl font-semibold text-white md:text-3xl">Chat to our friendly team</h1>
                    <p className="mt-3 text-gray-400">We’d love to hear from you. Please fill out this form or shoot us an email.</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-400">Visit our office to learn more about our products and services.</p>
                            <p className="mt-2 text-sm text-white">Kantaliya, pali, Rajasthan, India</p>
                        </div>
                        <div>
                            <span className="inline-block p-3 text-white rounded-full bg-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
                        ...
                        <form onSubmit={onSubmit}>
                            <div className="-mx-2 md:items-center md:flex">
                                <div className="flex-1 px-2">
                                    ...
                                    <input required name="first_name" type="text" placeholder="John" className="block w-full px-5 py-2.5 mt-2 text-gray-300   border border-gray-700 rounded-lg   outline-none" />
                                </div>
                                <div className="flex-1 px-2 mt-4 md:mt-0">
                                    <label className="block mb-2 text-sm text-gray-200">Last Name</label>
                                    <input required name="last_name" type="text" placeholder="Doe" className="block w-full px-5 py-2.5 mt-2 text-gray-300   border border-gray-700 rounded-lg   outline-none" />
                                </div>
                            </div>
                            <div className="-mx-2 md:items-center md:flex my-3">
                                <div className="flex-1 px-2">
                                    <label className="block mb-2 text-sm text-gray-200">Email</label>
                                    <input required name="email" type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-2.5 mt-2 text-gray-300   border border-gray-700 rounded-lg   outline-none" />
                                </div>
                                <div className="flex-1 px-2 mt-4 md:mt-0">
                                    <label className="block mb-2 text-sm text-gray-200">Phone</label>
                                    <input required name="phone" type="text" placeholder="+12-125-825" className="block w-full px-5 py-2.5 mt-2 text-gray-300   border border-gray-700 rounded-lg   outline-none" />
                                </div>
                            </div>
                            <div className="w-full mt-4">
                                <label className="block mb-2 text-sm text-gray-200">Message</label>
                                <textarea required name="message" className="block w-full h-32 px-5 py-2.5 mt-2 text-gray-300   border border-gray-700 rounded-lg md:h-56   outline-none" placeholder="Message"></textarea>
                            </div>
                            <button
                                type="submit"
